...
int main(int argc, char *argv[]) {
    long num_rounds = 20, Bsize = 1024*1024*64 ;
...
//    string funcName = "SHA256";
    ...
    for (int Nr = 1; Nr < 65; ++Nr) {
        DataSourceEstream S(0, ESTREAM_TEA, Nr);
...
//        DataSourceSHA3 S(0, SHA3_TANGLE, Nr, 16);
        ...
        string fileName = "/Volumes/EXTDATA/TEA-32-Round" +std::to_string(Nr) + ".bin";
